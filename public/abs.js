    ...
    (e.customStyles = {}),
      (e.Popup = (function() {
        var n = {
          ...
          onPopupOpen: function() {console.log('abc')},
          ...
          elements: {
            ...
            deny:
     '<a aria-label="deny cookies" role=button tabindex="0" class="cc-btn cc-deny">{{deny}}</a><div id="myModal" class="modal" style="display: none;"><div class="modal-content"><span class="close">&times;</span><p style="color:red">Some text in the Modal..</p></div></div>',
              deny1:
              '<div style="text-align: center"><div><input type="checkbox" id="vehicle1" name="vehicle1" value="Bike"><label for="vehicle1"> I have a bike</label></div/><div><input type="checkbox" id="vehicle1" name="vehicle1" value="Bike"><label for="vehicle1"> I have a bike</label></div></div>',
            link:
          ...
          compliance: {
            ...
            "opt-out":
              '{{deny1}}<div class="cc-compliance cc-highlight"><div></div>{{deny}}{{allow}}</div>',
          },
          type: "info",
          layouts: {
        ...
        function c(n) {
          ...
          return (
            ...
            (this.onButtonClick = function(n) {
              ...
              if (t.hasClass(o, "cc-btn2")){
                var modal = document.getElementById("myModal");
                modal.style.display = "block";
                a.removeEventListener("click").bind(this);
              }
